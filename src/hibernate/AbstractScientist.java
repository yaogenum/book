...
/**
 * AbstractScientist entity provides the base persistence definition of the
 * Scientist entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractScientist implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractScientist() {
	}

	/** full constructor */
	public AbstractScientist(String booksName, String booksTag,
