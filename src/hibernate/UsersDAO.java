...
public class UsersDAO extends BaseHibernateDAO {
	...
	public static final String USERS_IN = "usersIn";
	public static final String USERS_VIP = "usersVip";
	public static final String USERS_AGE = "usersAge";
	public static final String USERS_GRADES = "usersGrades";
	...
	public Users findById(java.lang.Integer id) {
		...
		try {
			Users instance = (Users) getSession().get("hibernate.Users", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Users instance) {
		...
		try {
			List results = getSession().createCriteria("hibernate.Users")
	...
	public List findByUsersIn(Object usersIn) {
		return findByProperty(USERS_IN, usersIn);
	}

	public List findByUsersVip(Object usersVip) {
		return findByProperty(USERS_VIP, usersVip);
	}
	...
	public List findByUsersGrades(Object usersGrades) {
		return findByProperty(USERS_GRADES, usersGrades);
	}
