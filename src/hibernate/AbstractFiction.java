...
/**
 * AbstractFiction entity provides the base persistence definition of the
 * Fiction entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractFiction implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractFiction() {
	}

	/** full constructor */
	public AbstractFiction(String booksName, String booksTag,
