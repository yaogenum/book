...
/**
 * AbstractEconomy entity provides the base persistence definition of the
 * Economy entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractEconomy implements java.io.Serializable {
	...
	/** full constructor */
	public AbstractEconomy(String booksName, String booksTag,
			String booksAuthor, Integer booksAmount, String booksStoragetime,
			String booksText, String booksPath, String booksPic,
			Integer booksXiazai, Integer booksLimit, String booksUploader) {
