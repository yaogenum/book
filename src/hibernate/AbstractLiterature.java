...
/**
 * AbstractLiterature entity provides the base persistence definition of the
 * Literature entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractLiterature implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractLiterature() {
	}

	/** full constructor */
	public AbstractLiterature(String booksName, String booksTag,
			String booksAuthor, Integer booksAmount, String booksStoragetime,
			String booksPath, String booksUploader, String booksPic,
			Integer booksXiazai, Integer booksLimit, String booksText) {
